...
if __name__ == '__main__':
    ...
    #model = torch.nn.DataParallel(model)                       #MODIFICA!
    #print(model)
    ...
    if not opt.no_train:
        ...
        print("number of train videos: ",len(training_data.data))
        ...
        train_loader = torch.utils.data.DataLoader(
            ...
            pin_memory=True)
        print("number of train_loader videos: ",len(train_loader.dataset.data))
        train_logger = Logger(
    ...
    if opt.resume_path:
        ...
        print(checkpoint["arch"], opt.arch)
